...
const Counter = () => {
  ...
  return (
      ...
      <Helmet>
        <title>Counter - Multi Tool</title>
        <meta
          name="description"
          content="A simple and easy-to-use counter tool. Use it for counting numbers, clicks, or any repetitive task."
        />
        <meta
          name="keywords"
          content="counter, click counter, tally counter, online counter"
        />
      </Helmet>
